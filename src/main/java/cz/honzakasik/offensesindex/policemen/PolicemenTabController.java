...
public class PolicemenTabController {
    ...
    public void initialize(DBManager dbManager) {
        ...
        policemenDepartmentSelector.setItems(departmentsDBManager.getAllDepartmentsNames());
    ...
    public void displayPolicemenFromDepartmentWithinYear() {
        ...
        if (result.isEmpty()) {
            DialogHelper.displayNothingFoundError((Stage)findPolicemenButton.getScene().getWindow());
            policemenYear.clear();
